...
retag: build
	...
	docker tag $(PDNS_ADMIN_IMAGE_NAME):$(PDNS_ADMIN_VERSION) $(PDNS_ADMIN_IMAGE_NAME):latest

push: retag
	docker push $(PDNS_IMAGE_NAME):$(PDNS_VERSION)
	docker push $(PDNS_IMAGE_NAME):latest
	docker push $(PDNS_ADMIN_IMAGE_NAME):$(PDNS_ADMIN_VERSION)
