...
: "${PDNS_ADMIN_SQLA_DB_OPTIONS:=}"

export PDNS_ADMIN_SQLA_DB_HOST PDNS_ADMIN_SQLA_DB_PORT PDNS_ADMIN_SQLA_DB_USER PDNS_ADMIN_SQLA_DB_PASSWORD PDNS_ADMIN_SQLA_DB_NAME PDNS_ADMIN_SQLA_DB_OPTIONS
...
cat /app/powerdnsadmin/default_config.py
...
until pg_isready -h ${PDNS_ADMIN_SQLA_DB_HOST} -p ${PDNS_ADMIN_SQLA_DB_PORT} -U ${PDNS_ADMIN_SQLA_DB_USER} -d ${PDNS_ADMIN_SQLA_DB_NAME}; do
